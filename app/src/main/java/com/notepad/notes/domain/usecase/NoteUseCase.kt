package com.notepad.notes.domain.usecase
...
import com.notepad.notes.data.repository.NoteRepositoryImpl
import com.notepad.notes.domain.model.Note
import com.notepad.notes.presentation.components.DecryptionResult
import com.notepad.notes.presentation.components.EncryptionHelper
import com.notepad.notes.widget.NotesWidget
...
class NoteUseCase @Inject constructor(
    ...
    suspend fun batchUpdateNotes(notes: List<Note>) {
        ...
        Log.d("NoteUseCase", "Tags JSON: ${com.notepad.notes.data.local.database.Converters().fromStringList(notesToSave.firstOrNull()?.tags ?: emptyList())}")
