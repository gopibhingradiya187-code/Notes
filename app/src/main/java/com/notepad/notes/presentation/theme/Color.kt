...
val primaryLight = Color(0xFF0B3BFF) // Dark teal
val primaryContainerLight = Color(0xFFE8F5E9) // Light green background
val onPrimaryContainerLight = Color(0xFF38468E) // Medium green
...
val inversePrimaryLight = Color(0xFF818DC7) // Match primaryLight
...
val primaryDark = Color(0xFFB9C6F6) // Soft mint green
val onPrimaryDark = Color(0xFF0B3BFF) // Dark teal
val primaryContainerDark = Color(0xFF315EFD) // Medium teal
