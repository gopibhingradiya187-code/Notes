package com.notepad.notes.presentation.screens.settings.settings
...
import com.notepad.notes.presentation.screens.settings.SettingsScaffold
import com.notepad.notes.presentation.screens.settings.TxtBackupHelper
                ...
                onPrimaryClick = {
                    if (webdavUrl.isBlank() || webdavUsername.isBlank() || webdavPassword.isBlank()) {
                        ...
                        coroutineScope.launch {
                            ...
                            workManager.enqueue(
                                OneTimeWorkRequestBuilder<com.notepad.notes.presentation.screens.settings.WebDAVBackupWorker>()
                                    .build()
                            )
                ...
                onSecondaryClick = {
                    if (webdavUrl.isBlank() || webdavUsername.isBlank() || webdavPassword.isBlank()) {
                        ...
                        coroutineScope.launch {
                            ...
                            workManager.enqueue(
                                OneTimeWorkRequestBuilder<com.notepad.notes.presentation.screens.settings.WebDAVRestoreWorker>()
                                    .build()
                            )
